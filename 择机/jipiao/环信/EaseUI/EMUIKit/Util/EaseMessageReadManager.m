...
- (MWPhotoBrowser *)photoBrowser
{
    if (_photoBrowser == nil) {
        ...
        _photoBrowser.enableSwipeToDismiss = YES;  //qxc123
        _photoBrowser.zoomPhotosToFill = YES;
        _photoBrowser.enableGrid = NO;
        _photoBrowser.startOnGrid = NO;
        //_photoBrowser.delayToHideElements = 0;
...
- (void)showBrowserWithImages:(NSArray *)imageArray
{
    ...
    [rootController presentViewController:self.photoNavigationController animated:YES completion:^{
        [rootController.navigationController setNavigationBarHidden:YES animated:YES];
    }];
}
