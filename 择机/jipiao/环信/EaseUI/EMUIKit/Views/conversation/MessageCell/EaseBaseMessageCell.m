...
- (void)configureSendLayoutConstraints
{
    ...
    //bubble view
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.avatarView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:-0]];
    ...
    _backImage.backgroundColor = [UIColor colorWithRed:223/255.0 green:224/255.0 blue:225/255.0 alpha:1.0];
    [_backImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.bubbleView.mas_right).offset(-cornerRadiusCHAT);
        make.right.equalTo(self.avatarView.mas_centerX);
...
- (void)configureRecvLayoutConstraints
{
    ...
    //bubble view
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.avatarView attribute:NSLayoutAttributeRight multiplier:1.0 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.nameLabel attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0]];
    
    _backImage.backgroundColor = [UIColor colorWithRed:197/255.0 green:239/255.0 blue:246/255.0 alpha:1.0];
    [_backImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.avatarView.mas_centerX);
        make.right.equalTo(self.bubbleView.mas_left).offset(cornerRadiusCHAT);
        make.top.equalTo(self.bubbleView);
        make.bottom.equalTo(self.avatarView);
    }];
}
...
+ (CGFloat)cellHeightWithModel:(id<IMessageModel>)model
{
    ...
    CGFloat minHeight = cell.avatarSize + 5 * 2;
