...
//        label.frame = defaultButton.frame;
        ...
        if (emotionManager.emotionType == EMEmotionDefault) {
            ...
            if ([GlobalObject attributedStringWithTextYE:emotion.emotionThumbnail] ) {
                [defaultButton setAttributedTitle:[GlobalObject attributedStringWithText:emotion.emotionThumbnail] forState:UIControlStateNormal];
//                defaultButton.attributedText =[GlobalObject attributedStringWithText:emotion.emotionThumbnail];
//                label.attributedText = [GlobalObject attributedStringWithText:emotion.emotionThumbnail];
                [defaultButton setTitle:nil forState:UIControlStateNormal];
            } else {
                [defaultButton setAttributedTitle:nil forState:UIControlStateNormal];
