...
+ (void)initialize
{
    ...
    cell.titleLabelFont = [UIFont systemFontOfSize:13];
    cell.detailLabelFont = [UIFont systemFontOfSize:10];
    cell.timeLabelFont = [UIFont systemFontOfSize:9];
    cell.titleLabelColor = [UIColor whiteColor];
    cell.detailLabelColor = [UIColor whiteColor];
    cell.timeLabelColor = [UIColor whiteColor];
              ...
              reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        view.backgroundColor = RGBACOLOR(134, 134, 134, 1.0);
...
- (void)_setupSubview
{
    ...
    _avatarView.imageCornerRadius = 20;//qxc
}
...
- (void)setModel:(id<IConversationModel>)model
{
    ...
    if (![_model.title isKindOfClass:[NSNull class]] && _model.title && [_model.title length] > 0) {
