...
- (void)initContentView
{
    if (_imageDatas.count)
    {
        ...
        for (int i = 0; i < _imageDatas.count; i++)
        {
            ...
            {
        _actionButton.frame = CGRectMake(0, 0, screenWidth, screenHeight);
//                if (iPhone6plus) {
//                    _actionButton.frame =
...
//                [_actionButton setTitle:@"立即体验" forState:UIControlStateNormal];
                [_actionButton setTitleColor:UIColorFromRGB(0x236b82) forState:UIControlStateNormal];
                [_actionButton setBackgroundImage:[UIImage imageNamed:@"guidePage_btn"] forState:UIControlStateNormal];
